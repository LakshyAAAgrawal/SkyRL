...
DATA_DIR="/home/ubuntu/SkyRL/hover_data"
...
MAX_PROMPT_LENGTH=2092
MAX_GENERATE_LENGTH=6612
...
uv run --isolated --extra $INFERENCE_BACKEND -m skyrl_train.entrypoints.main_base \
  ...
  trainer.export_path="$HOME/exports_hover_$CUR_TIME" \
  trainer.ckpt_path="$HOME/ckpts/hover_ckpt_$CUR_TIME" \
